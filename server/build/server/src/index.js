...
const Player_1 = __importDefault(require("../../common/Player"));
const Score_1 = __importDefault(require("../../common/Score"));
const Score_2 = require("../../common/Score");
const PlayGame_1 = __importDefault(require("./PlayGame"));
const fs = require('fs');
...
io.on('connection', (socket) => {
    ...
    socket.on('newName', (value) => {
        ...
        let player = new Player_1.default(socket.id, name, getRandomIntBtw(50, PlayGame_1.default.width - 50), getRandomIntBtw(50, PlayGame_1.default.height - 50), 1);
